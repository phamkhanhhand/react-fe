...
import { useDeleteFlexValueSetApi, useSaveFlexValueSetApi } from "../../services/flex-value-set.service";
...
export const useDeleteFlexValueSetMutation = () => {
  // return useMutation<ExampleResponse, Error, ExampleRequest>({
  return useMutation<any, Error, any>({
    mutationFn: useDeleteFlexValueSetApi, // ❗ function call API
